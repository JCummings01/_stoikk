...
$(document).ready(function () {
  ...
  var quoteList = [
    ...
    {quote: 'Let the spirit in you represent a man, an adult, a citizen, a Roman, a ruler. Taking up his post like a soldier and patiently awaiting his recall from life. Needing no oath or witness.', author: 'Marcus Aurelius'},
    {quote: 'The mind of one set straight and purified: no pus, no dirt, no scabs. And not a life cut short by death, like an actor who stops before the play is done, the plot wound up. Neither servility nor arrogance. Neither cringing nor disdain. Neither excuses nor evasions.', author: 'Marcus Aurelius'},
    {quote: 'Forget everything else. Keep hold of this alone and remember it: Each of us lives only now, this brief instant. The rest has been lived already, or is impossible to see. The span we live is small—small as the corner of the earth in which we live it. Small as even the greatest renown, passed from mouth to mouth by short-lived stick figures, ignorant alike of themselves and those long dead.', author: 'Marcus Aurelius'},
    {quote: 'No random actions, none not based on underlying principles.', author: 'Marcus Aurelius'},
    {quote: 'That sort of person is bound to do that. You might as well resent a fig tree for secreting juice. (Anyway, before very long you\'ll both be dead—dead and soon forgotten.)', author: 'Marcus Aurelius'},
    {quote: 'People who are excited by posthumous fame forget that the people who remember them will soon die too. And those after them in turn. Until their memory, passed from one to another like a candle flame, gutters and goes out.', author: 'Marcus Aurelius'},
    {quote: 'To be like the rock that the waves keep crashing over. It stands unmoved and the raging of the sea falls still around it.', author: 'Marcus Aurelius'},
    {quote: 'Some people, when they do someone a favor, are always looking for a chance to call it in. And some aren\'t, but they\'re still aware of it—still regard it as a debt. But others don\'t even do that. They\'re like a vine that produces grapes without looking for anything in return.', author: 'Marcus Aurelius'},
    ...
    {quote: 'The things you think about determine the quality of your mind. Your soul takes on the color of your thoughts.', author: 'Marcus Aurelius'},
    {quote: 'In a sense, people are our proper occupation. Our job is to do them good and put up with them. But when they obstruct our proper tasks, they become irrelevant to us—like sun, wind, animals. Our actions may be impeded by them, but there can be no impeding our intentions or our dispositions. Because we can accommodate and adapt.', author: 'Marcus Aurelius'},
    {quote: 'So other people hurt me? That\'s their problem. Their character and actions are not mine. What is done to me is ordained by nature, what I do by my own.', author: 'Marcus Aurelius'},
    {quote: 'The best revenge is not to be like that.', author: 'Marcus Aurelius'},
    {quote: 'Not to assume it\'s impossible because you find it hard. But to recognize that if it\'s humanly possible, you can do it too.', author: 'Marcus Aurelius'},
    {quote: 'If anyone can refute me—show me I\'m making a mistake or looking at things from the wrong perspective—I\'ll gladly change. It\'s the truth I\'m after, and the truth never harmed anyone. What harms us is to persist in self-deceit and ignorance.', author: 'Marcus Aurelius'},
    {quote: 'How cruel—to forbid people to want what they think is good for them. And yet that\'s just what you won\'t let them do when you get angry at their misbehavior. They\'re drawn toward what they think is good for them. — But it\'s not good for them. — Then show them that. Prove it to them. Instead of losing your temper.', author: 'Marcus Aurelius'},
    {quote: 'When you need encouragement, think of the qualities the people around you have: this one\'s energy, that one\'s modesty, another\'s generosity, and so on. Nothing is as encouraging as when virtues are visibly embodied in the people around us, when we\'re practically showered with them.', author: 'Marcus Aurelius'},
    ...
    {quote: 'Ambition means tying your well-being to what other people say or do. Self-indulgence means tying it to the things that happen to you. Sanity means tying it to your own actions.', author: 'Marcus Aurelius'},
    {quote: 'Honey tastes bitter to a man with jaundice. People with rabies are terrified of water. And a child\'s idea of beauty is a ball. Why does that upset you? Do you think falsehood is less powerful than bile or a rabid dog?', author: 'Marcus Aurelius'},
    {quote: 'Don\'t be ashamed to need help. Like a soldier storming a wall, you have a mission to accomplish. And if you\'ve been wounded and you need a comrade to pull you up? So what?', author: 'Marcus Aurelius'},
    {quote: 'Wash yourself clean. With simplicity, with humility, with indifference to everything but right and wrong.', author: 'Marcus Aurelius'},
    {quote: 'Not a dancer but a wrestler: waiting, poised and dug in, for sudden assaults.', author: 'Marcus Aurelius'},
    {quote: 'Look at who they really are, the people whose approval you long for, and what their minds are really like. Then you won\'t blame the ones who make mistakes they can\'t help, and you won\'t feel a need for their approval.', author: 'Marcus Aurelius'},
    {quote: 'It\'s silly to try to escape other people\'s faults. They are inescapable. Just try to escape your own.', author: 'Marcus Aurelius'},
    {quote: 'Concentrate on what you have to do. Fix your eyes on it. Remind yourself that your task is to be a good human being; remind yourself what nature demands of people. Then do it, without hesitation, and speak the truth as you see it. But with kindness. With humility. Without hypocrisy.', author: 'Marcus Aurelius'},
    {quote: 'Remember: you shouldn\'t be surprised that a fig tree produces figs, nor the world what it produces. A good doctor isn\'t surprised when his patients have fevers, or a helmsman when the wind blows against him.', author: 'Marcus Aurelius'},
    {quote: 'Blame no one. Set people straight, if you can. If not, just repair the damage. And suppose you can\'t do that either. Then where does blaming people get you? No pointless actions.', author: 'Marcus Aurelius'},
    {quote: 'The cucumber is bitter? Then throw it out. There are brambles in the path? Then go around them.', author: 'Marcus Aurelius'},
    {quote: 'You want praise from people who kick themselves every fifteen minutes, the approval of people who despise themselves. (Is it a sign of self-respect to regret nearly everything you do?)', author: 'Marcus Aurelius'},
    {quote: 'People exist for one another. You can instruct or endure them.', author: 'Marcus Aurelius'},
  ];
